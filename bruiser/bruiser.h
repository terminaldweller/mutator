...
help CMDHelp[] = {
  ...
  {"Vars()", "lists all variables", "lists all available variable declarations", "none", "returns a string array of the variable declarations"},
  {"Funcs()", "lists all functions", "lists all available function declarations", "none", "returns a string array of the function declarations"},
  {"Classess()", "lists all classes", "lists all available class declarations", "none", "returns a string array of the class declarations"},
  {"Structs()", "lists all structs", "lists all available struct declarations", "none", "returns a string array of the structur declarations"},
  {"Arrays()", "lists all arrays", "lists all available array declarations", "none", "returns a string array of the array declarations"},
  {"Unions()", "lists all unions", "lists all available union declarations", "none", "returns a string array of the union declarations"},
  {"make()", "runs your make command", "runs your make command", "", ""},
  {"historysize()", "sets the history size", "sets the history size", "[uint history_size]", ""},
  {"showsource()", "sets the history size", "sets the history size", "[uint beginline, uint endline, string filename]", "returns a string array of the returned source file"}
};
/**********************************************************************************************************************/
/**
